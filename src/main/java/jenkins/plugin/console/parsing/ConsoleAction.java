...
public class ConsoleAction implements Action {
    ...
    final private ConsoleResult result;

    private static String urlName = "parsed_console";

    @Deprecated
    public ConsoleAction(final AbstractBuild<?, ?> build, final ConsoleResult result) {
        this((Run<?, ?>) build, result);
    }

    public ConsoleAction(final Run<?, ?> build, final ConsoleResult result) {
        this.build = build;
        this.result = result;
    ...
    public ConsoleAction getPreviousAction() {
        ...
        while (true) {
            ...
            if (build == null)
                return null;
            ConsoleAction action = build.getAction(ConsoleAction.class);
            if (action != null)
                return action;
        }
    }
    ...
    private CategoryDataset buildDataSet() {
        ...
        for (ConsoleAction a = this; a != null; a = a.getPreviousAction()) {
