...
public final class ConsoleUtils {
    ...
    public static CompiledPatterns compilePatterns(
            final String[] parsingRulesArray, final Logger logger) {
    ...
    public static int getNumThreads() {
        int result = ConsoleConstants.MAX_THREADS;
        final String maxThreadsByEnvStr = System
        ...
        if (maxThreadsByEnvStr != null) {
            try {
                ...
                Logger.getLogger("getNumThreads").log(Level.FINEST,
                        "HUDSON_LOG_PARSER_THREADS" + ConsoleConstants.NOT_INT);
            }
        }
        return result;
    }
    ...
    public static int getLinesPerThread() {
        int result = ConsoleConstants.LINES_PER_THREAD;
        final String linesByEnvStr = System
        ...
        if (linesByEnvStr != null) {
            try {
                ...
                Logger.getLogger("getLinesPerThread").log(Level.FINEST,
                    "HUDSON_LOG_PARSER_LINES_PER_THREAD" + ConsoleConstants.NOT_INT);
            }
        }
        return result;
    }
