...
import jenkins.plugin.console.action.ConsoleProjectAction;
...
public class ConsolePublisher extends Recorder implements SimpleBuildStep, Serializable {
     ...
     */
    @Deprecated
    private ConsolePublisher(final boolean unstableOnWarning,
    ...
    public ConsolePublisher(boolean useProjectRule, String projectRulePath, String parsingRulesPath) {
        super();
        if (useProjectRule) {
    ...
    public void perform(Run<?, ?> build, FilePath workspace, Launcher launcher, TaskListener listener) throws
        ...
        try {
            ...
            final ConsoleParser parser = new ConsoleParser(parsingRulesFile, preformattedHtml, launcher.getChannel());
            ...
            logger.log(Level.SEVERE, ConsoleConstants.CANNOT_PARSE + build, e);
        ...
        final ConsoleAction action = new ConsoleAction(build, result);
    ...
    public static final class DescriptorImpl extends
        ...
        private volatile ConsoleRules[] parsingRulesGlobal = new ConsoleRules[0];
        private boolean useLegacyFormatting = false;

        private DescriptorImpl() {
            super(ConsolePublisher.class);
            load();
        }
        ...
        public ConsoleRules[] getParsingRulesGlobal() {
        ...
        public boolean configure(final StaplerRequest req, final JSONObject json)
            ...
            parsingRulesGlobal = req.bindParametersToList(ConsoleRules.class,
                    "log-parser.").toArray(new ConsoleRules[0]);
     ...
     */
    public ConsoleRules[] getParserRuleChoices() {
    ...
    public Action getProjectAction(AbstractProject<?, ?> project) {
        ...
        if (showGraphs)
            return new ConsoleProjectAction(project);
        else
            return null;
    }
